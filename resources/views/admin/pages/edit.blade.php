                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="meta_description" name="meta_description" type="text"
                                    class="mt-1 block w-full" :value="old('meta_description', $page->meta_description)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="meta_keywords" name="meta_keywords" type="text"
                                    class="mt-1 block w-full" :value="old('meta_keywords', $page->meta_keywords)" />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="page" {{ old('type', $page->type) == 'page' ? 'selected' : '' }}>Page</option>
                                        <option value="product" {{ old('type', $page->type) == 'product' ? 'selected' : '' }}>Product</option>
                                        <option value="service" {{ old('type', $page->type) == 'service' ? 'selected' : '' }}>Service</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="layout" name="layout" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="sidebar" {{ old('layout', $page->layout) == 'sidebar' ? 'selected' : '' }}>With Sidebar</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="published_at" name="published_at" type="datetime-local"
                                        class="mt-1 block w-full" :value="old('published_at', $page->published_at?->format('Y-m-d\TH:i'))" />
