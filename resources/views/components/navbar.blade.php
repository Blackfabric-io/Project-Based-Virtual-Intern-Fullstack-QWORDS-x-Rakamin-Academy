<nav class="bg-white shadow-md">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <a href="{{ route('landing.page') }}" class="text-2xl font-bold text-blue-600">QWords</a>
        <div class="hidden md:flex space-x-6">
            <a href="{{ route('landing.page') }}" class="text-gray-700 hover:text-blue-600">Home</a>
            ...
            <a href="{{ route('contact.show') }}" class="text-gray-700 hover:text-blue-600">Contact</a>
    ...
    <div class="md:hidden hidden" id="mobile-menu">
        <a href="{{ route('landing.page') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Home</a>
        ...
        <a href="{{ route('contact.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Contact</a>
